          ...
          bg-black">
            ...
            <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
              ...
              md:pt-0">
                    ...
                    <li>
                        <a class="md:p-4 py-2 block hover:text-purple-700" href="{{ url('productos') }}">Productos</a>
                    </li>
                    @canany(['crear', 'administrar'])
                        <li>
                            <a class="md:p-4 py-2 block hover:text-purple-700" href="{{ url('tipofibra') }}">Fibras</a>
                        </li>
                        <li>
                            <a class="md:p-4 py-2 block hover:text-purple-700" href="{{ url('coleccion') }}">Coleccion</a>
                        </li>
                    @endcan
                    @can('administrar')
                        <li>
                            <a class="md:p-4 py-2 block hover:text-purple-700" href="{{ url('permission') }}">admin
                                usuarios</a>
                        </li>
                    @endcan

                    <li>
                        <a class="md:p-4 py-2 block hover:text-purple-700" href="{{ url('nosotros') }}">Nosotros</a>
                    </li>
                    <li>
                        <a class="md:p-4 py-2 block hover:text-purple-700" href="{{ url('contactos') }}">Contactos</a>
                    </li>
