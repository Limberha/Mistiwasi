        ...
        <div class="grid grid-cols-2 grid-rows-1 gap-4 m-2">
            ...
            <div>
                <button data-toggle="modal" type="button"
                    ...
                    <span class="flex items-center justify-center space-x-2">Agregar usuario</span>
                </button>
            </div>
        </div>
            ...
            <article class="modal-content flex flex-col relative m-0 rounded-md bg-white sm:my-16"
                ...
                <x-form enctype="multipart/form-data">
                    <header class="flex p-4 items-center justify-between">
                        <h2 class="m-0 text-xl font-medium max-w-[calc(100%_-_3rem)]">Añadir usuario</h2>
                        <button type="button"
                    ...
                    <main class="relative flex-[1_1_auto] p-4" style="--size: 32rem">
                        <div>
                            <label for="" class="block text-gray-700 text-sm font-bold mb-2">Nombre de
                                usuario</label>
                            <input
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="text" name="name" id="" placeholder="nombre de usuario">
                        </div>

                        <div class="mb-3">
                            <label for="" class="block text-gray-700 text-sm font-bold mb-2">Email</label>
                            <input type="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="email" id=""
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="password" id=""
                                placeholder="">
                        </div>

                        <div class="mb-3">
                            <label for="" class="block text-gray-700 text-sm font-bold mb-2">Confirmacion Password</label>
                            <input type="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="conf-password" id=""
                                placeholder="">
                        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">usuario
                                </th>
                            </tr>
