...
<body>
    ...
    <main class=" items-center justify-center bg-white p-5">
        <div class="grid grid-cols-2 grid-rows-1 gap-4 m-2">
            <div> Administrador de permisos </div>
            <div>
                <button data-toggle="modal" type="button"
                    ...
                    <span class="flex items-center justify-center space-x-2">Agregar permiso</span>
                </button>
            </div>
        </div>
            ...
            <article class="modal-content flex flex-col relative m-0 rounded-md bg-white sm:my-16"
                ...
                <x-form enctype="multipart/form-data">
                    <header class="flex p-4 items-center justify-between">
                        <h2 class="m-0 text-xl font-medium max-w-[calc(100%_-_3rem)]">Añadir permiso</h2>
                        <button type="button"
                    ...
                    <main class="relative flex-[1_1_auto] p-4" style="--size: 32rem">
                        <div>
                            ...
                            <input
                                ...
                                type="text" name="name" id="" placeholder="nombre de permiso">
                        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Permisos
                                </th>
                            </tr>

                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($listaPer as $pr)
