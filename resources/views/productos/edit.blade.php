                    ...
                    <div class="rounded p-4 px-4 md:p-8 mb-6">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                            <div class="text-gray-600">
                                ...
                                <img src="{{ url($pr->img) }}" alt="" class="h-auto max-w-full">
                                    ...
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        <div class="md:col-span-5">
                                            ...
                                            <input
                                                ...
                                                placeholder="nombre de producto" value="{{ $pr->nombre }}">
                                        </div>

                                        <div class="md:col-span-5">

                                            <label for=""
                                                class="block text-gray-700 text-sm font-semibold mb-2">Imagen</label>
                                            <input
                                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                                type="file" name="img" id=""
                                                placeholder="nombre de producto" aria-describedby="seleccion archivo">
                                        </div>

                                        <div class="md:col-span-5">
                                            <label for=""
                                                class="block text-gray-700 text-sm font-bold mb-2">Gramos</label>
                                            <input
                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        ...
                                        <div class="md:col-span-3">
                                            <label for=""
                                                class="block text-gray-700 text-sm font-semibold mb-2">Palitos
                                                crochet</label>
                                            <input
                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                type="text" name="palitos_crochet" id=""
                                                placeholder="Tamaño de crochet " value="{{ $pr->palitos_crochet }}">
                                        </div>

                                        <div class="md:col-span-2">
                                            <label for=""
                                                class="block text-gray-700 text-sm font-semibold mb-2">Precio</label>
                                            <input
                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                type="number" name="precio" id=""
                                                placeholder="precio del producto" value="{{ $pr->precio }}">
                                        </div>

                                        <div class="md:col-span-2">
                                            <label for=""
                                                class="block text-gray-700 text-sm font-bold mb-2">Tipo de
                                                fibra</label>
                                            <select
                                                class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                name="tipo_fibra_id" id="" value="{{ $pr->tipo_fibra_id }}">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <input
                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                type="number" name="stock" id=""
                                                placeholder="existencias del producto" value="{{ $pr->stock }}">
                                        </div>

                                        <div class="md:col-span-1">
                                            <label for=""
                                                class="block text-gray-700 text-sm font-bold mb-2">Coleccion</label>
                                            <select
                                                class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                name="coleccion_id" id="" value="{{ $pr->coleccion_id }}">
                                        ...
                                        <div class="md:col-span-5">
                                            <label for=""
                                                class="block text-gray-700 text-sm font-bold mb-2">Grosor</label>
                                            <input
                                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                type="text" name="grosor" id=""
                                                placeholder="grosor del producto" value="{{ $pr->grosor }}">
                                        ...
                                        <div class="md:col-span-5 text-right">
                                            <div class="inline-flex items-end">
                                                <button type="submit"
                                                    class=" hover:bg-blue-700 hover:text-white flex items-center justify-center px-4 font-medium bg-blue-500 text-gray-800 h-9 rounded-md">
